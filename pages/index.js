  ...
  <div className="flex items-center space-x-4">
   <h1 className="logo w-48 sm:w36" >
      <a className="flex-none  " href="https://www.blendibox.com.br/" title="Blendibox - Comprar Moda Online" >          
            <img  className="" src="https://cdn.awsli.com.br/400x300/1985/1985921/logo/fe34120478.png" alt="Blendibox - Comprar Moda Online"/>            
      </a>
    </h1>
          ...
          <li key={id} className="text-sm leading-6 place-content-stretch  rounded-lg p-6 bg-white border hover:border-gray-200 shadow-md hover:shadow-xl">
                  ...
                  <figcaption  className="  flex items-center space-x-4  text-xs font-tiny text-ellipsis"  > 
                       ...
                       
                     {
                       ...
                       product.rawTagName == 'img' ?   
                         ...
                         <img key={ia++} placement="top" src={product.getAttribute('src')} className="flex-none w-20 h-20  relative contrast-125" data-tip="hello world" ></img> 
            ...
            <div className="flex items-center space-x-4">            
                   ...
                   {(() => {
                    ...
                    if (review.Avatar == "") {
                        return (
                           <img className="contrast-125 flex-none w-14 h-14 rounded-full object-cover" 
